...
<body class="w3-content w3-black" style="max-width:1500px;">
    <header class="w3-display-container w3-center">
            ...
            <div class="w3-display-middle w3-padding w3-hide-small " style="width:50%">
                <div class="w3-black w3-padding-large w3-round-large" style="color: #A9A9A9;">
                    <h1>Sàn giao dịch Thực tập sinh</h1>
                    <hr class="w3-opacity">
                    <div class="w3-black w3-padding-large w3-round-large">
                        <div class="w3-bar">
                            <button class="w3-bar-item w3-button" onclick="select_tab('student')">Log in as Student</button>
                            <button class="w3-bar-item w3-button" onclick="select_tab('professor')">Log in as Professor</button>
                            <button class="w3-bar-item w3-button" onclick="select_tab('company')">Log in as Company</button>
                        </div>
