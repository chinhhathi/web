...
WHERE id IN (SELECT student_id
        ...
        <div class="w3-top">
            <div class="w3-bar w3-theme-d2 w3-left-align">
                ...
                <a href="professor_home.php" class="w3-bar-item w3-button w3-teal"><i
                ...
                <div style="float: right" class="w3-dropdown-hover w3-hide-small">
                    <button class="w3-button w3-teal "
                            title="Notifications"><?php echo $professor_profile['full_name'] ?><i
        ...
        <form action="scr_1002E_change.php" method="post">
            <div class="w3-content w3-padding-top  w3-white w3-margin-bottom w3-margin-top" style="max-width:1200px;">
                ...
                <div class="w3-card w3-padding">
                    <i class="fa fa-home w3-margin-right"><a href="#" style="text-decoration: none"
                                                             class="w3-hover-opacity"></i>Trang chủ</a> /
                    ...
                    while ($row = $query8->fetch_assoc()) {
                        ...
                        <div class="w3-padding">
                            <ul class="w3-ul w3-border w3-hover-shadow">
                                ...
                                <li class="w3-padding"><b>Tên sinh viên: </b> <?php echo $row['first_name'];
                                    echo " ";
                                    echo $row['sur_name'];
                                    echo " ";
                                ...
                                <li class="w3-padding"><b>Ngày bắt đầu thực tập: </b><?php echo $row['start_date']; ?>
                                </li>
                                <li class="w3-padding"><b>Ngày kết thúc thực tập: </b><?php echo $row['end_date']; ?>
                                </li>
                            </ul>
                        </div>
                    <?php } ?>
                ...
                <div style="padding-top:1px;">
                    ...
                    <a class="w3-button w3-teal w3-padding w3-round-large" href="professor_home.php"><i
                                class="fa fa-check"></i>Trở về</a>
