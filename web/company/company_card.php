...
<div class="w3-card">
    <button class="w3-teal w3-padding w3-round-large"><a href="create_newcard.php" style="text-decoration: none">Tạo mới Phiếu tuyển dụng</a></button>
</div>
<div class="w3-col m5 w3-card w3-margin-bottom w3-round-large">
    <ul class="w3-ul w3-border w3-hover-shadow">
        ...
        <li class="w3-theme-l5 w3-padding">
            <button class="w3-button w3-teal w3-padding-large w3-round-large"><i class="fa fa-check"></i>Xem chi tiết</button>
            <button class="w3-button w3-teal w3-padding-large w3-round-large"><i class="fa fa-check"></i>Xem bảng phân công</button>
        </li>
